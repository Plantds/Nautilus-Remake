...
[VolumeComponentMenu("Post-processing Custom/Airlock")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(AirlockRendererFeature))]
...
public sealed class AirlockVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public AirlockVolumeComponent()
    {
        displayName = "Airlock";
    }
    ...
    public ColorParameter color = new ColorParameter(new Color(55, 48, 34, 255));
