...
[VolumeComponentMenu("Post-processing Custom/Deep Water")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(UnderWaterRendererFeature))]
...
public sealed class UnderWaterVolumeComponent : VolumeComponent, IPostProcessComponent
{
    ...
    public UnderWaterVolumeComponent()
    {
    ...
    public ClampedFloatParameter depth = new ClampedFloatParameter(1f, 0f, 1f);
    public ColorParameter depthcolor = new ColorParameter(new Color(0.07791f, 0.07791921f, 0.1603774f));
    public ClampedFloatParameter near = new ClampedFloatParameter(0.02f, 0f, 1000f);
    public ClampedFloatParameter far = new ClampedFloatParameter(5f, 0f, 10000f);
