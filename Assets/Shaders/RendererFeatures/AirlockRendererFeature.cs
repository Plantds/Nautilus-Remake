...
public sealed class AirlockRendererFeature : ScriptableRendererFeature
{
    ...
    [SerializeField] private float debugIntensity = 0.0f;
    [SerializeField] private float debugHeight = 0.0f;

    [SerializeField] public static float targetHeight = 100.0f;
    [SerializeField] public static float intensity = 0.0f;
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        // AirlockVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<AirlockVolumeComponent>();
        ...
        CustomPostRenderPass.debugMode = debugMode;
        CustomPostRenderPass.debugIntensity = debugIntensity;
        CustomPostRenderPass.debugHeight = debugHeight;
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        public static float debugIntensity = 0.0f;
        public static float debugHeight = 0.0f;
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            if (debugMode)
            {
                s_SharedPropertyBlock.SetFloat("_Intensity", debugIntensity);
                s_SharedPropertyBlock.SetFloat("_TargetHeight", debugHeight);
            }
            else
            {
                s_SharedPropertyBlock.SetFloat("_Intensity", intensity);
                s_SharedPropertyBlock.SetFloat("_TargetHeight", targetHeight);
                // s_SharedPropertyBlock.SetColor("_Color", myVolume.color.GetValue<Color>());
            }
