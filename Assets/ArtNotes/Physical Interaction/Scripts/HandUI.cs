...
namespace ArtNotes.PhysicalInteraction
{
    ...
    public class HandUI : MonoBehaviour
    {
        ...
        [SerializeField] Texture _grab, _door, _button, _Inspect,_Fixa;
        ...
        public void SetTexture(PlayerLooking.HandMode hand)
        {
            switch (hand)
            {
                ...
                case PlayerLooking.HandMode.button:
                    ...
                    break;
                case PlayerLooking.HandMode.Inspect:
                    if (_image.texture != _Inspect) _image.texture = _Inspect;
                    break;
                case PlayerLooking.HandMode.Fixa:
                    if (_image.texture != _Fixa) _image.texture = _Fixa;
                    break;
                default:
                    if (_image.texture != _default) _image.texture = _default;
                    break;
