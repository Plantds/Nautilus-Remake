...
public class SC_AnimationPlayer : MonoBehaviour
{
    [Header("Animation")]
    ...
    [Tooltip("Emitter used when playing the animation forward (e.g. OPEN).")]
    [SerializeField] private StudioEventEmitter forwardEmitter;

    [Tooltip("Emitter used when playing the animation in reverse (e.g. CLOSE).")]
