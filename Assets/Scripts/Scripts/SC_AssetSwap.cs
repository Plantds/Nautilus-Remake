...
public class SC_AssetSwap : MonoBehaviour
{
    ...
    void SwapPrefabs(GameObject oldGameObject)
    {
        ...
        Transform transform = oldGameObject.transform;
        ...
        GameObject newGameObject = Instantiate(newPrefab, transform);
...
[CustomEditor(typeof(SC_AssetSwap))]
public class PrefabSwitchEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        SC_AssetSwap prefabSwitch = (SC_AssetSwap)target;
